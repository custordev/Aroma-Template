...
function Footer() {
  ...
  return (
    <footer className="p-4 bg-gradient-to-t from-indigo-950 via-slate-900 to-slate-950  text-white  sm:p-6  max-w-full  ">
      <div className="mx-auto max-w-screen-xl">
        ...
        <div className=" flex flex-col py-6 lg:flex-row items-center justify-between">
          ...
          <div className="flex gap-6">
            <span className="text-sm flex gap-2  sm:text-center  hover:font-semibold">
              Powered By{" "}
              <Link
                href="www.desishub.com"
