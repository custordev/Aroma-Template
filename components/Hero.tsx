...
export default function Hero() {
  return (
    <section>
      <div className="flex items-center justify-between bg-gradient-to-b from-blue-950 via-slate-900 to-blue-950 min-h-full lg:h-[30rem] w-full  lg:px-12 lg:py-8 lg:flex-row rounded-3xl lg:mt-16 md:flex-col md:h-[81vh] md:mt-14 gap-6 flex-col mt-6 h-[100vh] px-6 py-8">
        ...
        <div className="">
          <Image
            width={1080}
            height={1080}
            className="w-full h-[25rem] lg:h-[28rem] "
