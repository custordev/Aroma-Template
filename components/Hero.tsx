...
export default function Hero() {
  return (
    <section>
      <div className="flex items-center justify-between bg-gradient-to-b from-blue-950 via-slate-900 to-blue-950 min-h-full lg:h-[29rem] w-full  lg:px-12 lg:py-8 lg:flex-row rounded-3xl lg:mt-16 md:flex-col md:h-[80vh] md:mt-14 gap-6 flex-col mt-6 h-[84vh] px-4 py-4">
